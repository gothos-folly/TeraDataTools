...
namespace Data.Structures.Player
{
    ...
    public class Player : Creature.Creature
    {
        ...
        public byte PlayerPraiseGiven = 0;

        // when the last praise was given
        public int PlayerLastPraise = -1;
        ...
        public int PlayerCreationDate = Funcs.GetRoundedUtc();
        public int PlayerLastOnlineUtc = Funcs.GetRoundedUtc();
        ...
        public long PlayerExpRecoverable;
